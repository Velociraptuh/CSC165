...
public class MyGame extends VariableFrameRateGame
{
	...
	{	Matrix4f initialTranslation, initialScale, initialRotation, rotateX, rotateY, rotateZ;
		...
		initialScale = (new Matrix4f()).scale(100f, 1.0f, 100f);
		...
		initialTranslation = (new Matrix4f()).translation(20, 2, 5);
		initialScale = (new Matrix4f()).scaling(2f);
	...
	public ObjShape getNPCShape(){return spiderS;}
	public TextureImage getNPCTexture(){return spiderTx;}
