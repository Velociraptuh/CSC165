...
public class FindComponents{
	...
	public void listControllers(){
		...
		//Print details and sub-controllers for each controller
	...
	//Report the component information of a controller
	...
	private void listComponents(Controller contr){
		...
		//Find subcontrollers, if any, recursively list their details too
